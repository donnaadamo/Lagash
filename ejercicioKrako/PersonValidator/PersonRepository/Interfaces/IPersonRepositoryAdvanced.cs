...
namespace PersonRepository.Interfaces
{
    public interface IPersonRepositoryAdvanced : IPersonRepositoryBasic
    {
        ...
        /// <summary>
        /// Obtiene un lista agrupada de los emails de las personas por la 
        //cantidad de nombres que tiene su nombre (si es "juan lopez"
        // es 2, si es "juan carlos lopez" es 3, si es "juan carlos lopez garcia" es 4)
        /// </summary>
        /// <returns>Un diccionario que tiene como key la cantidad de nombres,
        // y como value un array con todos los emails de las personas que tienen 
        //esa cantidad de nombres en el nombre</returns>
